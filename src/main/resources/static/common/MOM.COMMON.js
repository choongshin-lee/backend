...
function mom_ajax(type, url, param, call_back, call_back_param, index_info, your, async, commitYn, actionMode, file) {
...
function excelUploadGrid(file, index, grid, validate) {
	var excelData = [];
